...
import com.guoxiaoxing.phoenix.picker.ui.camera.util.ImageUtils;
...
public class CameraPreviewActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private AutoFitFrameLayout videoPreviewContainer;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        videoPreviewContainer = (AutoFitFrameLayout) findViewById(R.id.previewAspectFrameLayout);
        ...
        if (mediaAction == CameraConfig.MEDIA_ACTION_VIDEO) {
            displayVideo(savedInstanceState);
        } else if (mediaAction == CameraConfig.MEDIA_ACTION_PHOTO) {
            displayImage();
        } else {
            String mimeType = DeviceUtils.getMimeType(previewFilePath);
    ...
    private void showImagePreview() {
        ...
        ImageUtils.Builder builder = new ImageUtils.Builder(this);
