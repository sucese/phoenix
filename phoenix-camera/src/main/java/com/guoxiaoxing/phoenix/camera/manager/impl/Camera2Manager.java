...
public final class Camera2Manager extends BaseCameraManager<String, TextureView.SurfaceTextureListener>
    ...
    public void openCamera(String cameraId, final CameraOpenListener<String, TextureView.SurfaceTextureListener> cameraOpenListener) {
        ...
        backgroundHandler.post(new Runnable() {
            @Override
            public void run() {
                if (context == null || cameraConfigProvider == null) {
    ...
    public CharSequence[] getVideoQualityOptions() {
        ...
        CamcorderProfile camcorderProfile = CameraHelper.getCamcorderProfile(CameraConfig.MEDIA_QUALITY_HIGH, currentCameraId);
        ...
        camcorderProfile = CameraHelper.getCamcorderProfile(CameraConfig.MEDIA_QUALITY_MEDIUM, currentCameraId);
        ...
        camcorderProfile = CameraHelper.getCamcorderProfile(CameraConfig.MEDIA_QUALITY_LOW, currentCameraId);
        videoDuration = CameraHelper.calculateApproximateVideoDuration(camcorderProfile, cameraConfigProvider.getVideoFileSize());
