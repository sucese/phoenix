...
Java_com_guoxiaoxing_phoenix_compress_video_soft_interfaces_FFmpegBridge_prepareJXFFmpegEncoder(JNIEnv *env,
                                                                                        jclass type,
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_guoxiaoxing_phoenix_compress_video_soft_interfaces_FFmpegBridge_encodeFrame2H264(JNIEnv *env,
                                                                                  jclass type,
                                                                                  jbyteArray data_) {
...
Java_com_guoxiaoxing_phoenix_compress_video_soft_interfaces_FFmpegBridge_getFFmpegConfig(JNIEnv *env,
                                                                                 jclass type) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_guoxiaoxing_phoenix_compress_video_soft_interfaces_FFmpegBridge_encodeFrame2AAC(JNIEnv *env,
                                                                                 jclass type,
                                                                                 jbyteArray data_) {
    jbyte *elements = env->GetByteArrayElements(data_, 0);
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_guoxiaoxing_phoenix_compress_video_soft_interfaces_FFmpegBridge_recordEnd(JNIEnv *env,
                                                                           jclass type) {
...
Java_com_guoxiaoxing_phoenix_compress_video_soft_interfaces_FFmpegBridge_nativeRelease(JNIEnv *env,
                                                                               jclass type) {
