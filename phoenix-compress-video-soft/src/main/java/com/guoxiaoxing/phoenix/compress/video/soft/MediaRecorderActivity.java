...
import com.guoxiaoxing.phoenix.compress.video.soft.util.FileUtils;
import com.guoxiaoxing.phoenix.compress.video.soft.util.StringUtils;
 ...
 * @author guoxiaoxing
 */
public class MediaRecorderActivity extends Activity implements MediaRecorderBase.OnErrorListener, OnClickListener
        , MediaRecorderBase.OnPreparedListener, MediaRecorderBase.OnEncodeListener {
...
//        mRecordDelete.setOnClickListener(this);
    ...
    private void setupMediaRecorder() {
        ...
        File f = new File(SCCamera.getVideoCachePath());
        if (!FileUtils.checkFile(f)) {
            f.mkdirs();
        }
        String key = String.valueOf(System.currentTimeMillis());
        mMediaObject = mMediaRecorder.setOutputDirectory(key,
                SCCamera.getVideoCachePath() + key);
